...
import type { AttentionItem, AttentionTarget, FundFreshness, WorkspaceSummary } from "@/core/workspace-summary";
...
export function OverviewView({
  ...
  return <>
    ...
    {reviewFirst || audience === "admin" ? <>{attentionSection}{exposureSection}</> : <>{exposureSection}{attentionSection}</>}

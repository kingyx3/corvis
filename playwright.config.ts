...
export default defineConfig({
  ...
  // fullyParallel above only shards tests across workers; CI runners have
  // multiple cores available, so give Playwright more than one worker to
  // actually use them instead of running every test serially.

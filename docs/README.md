...
- [`SOC1_READINESS.md`](SOC1_READINESS.md) — repository-side SOC 1 ICFR readiness boundary, financially relevant control objectives, evidence contract and audit gates.
